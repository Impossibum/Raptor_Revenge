...
class SharedPPO:
    ...
    def load(self, load_location, continue_iterations=True):
        ...
        #self.agent.transformer.load_state_dict(checkpoint['transformer_state_dict'])
    ...
    def save(self, save_location, current_step, save_actor_jit=False):
        ...
        torch.save({
            ...
            #'transformer_state_dict': self.agent.transformer.state_dict(),
